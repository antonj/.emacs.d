...
(let (
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((t (:background "plum" :foreground "black" :underline nil :box (:line-width 1 :color "plum3" :style unspecified)))))
   `(mode-line-inactive ((t (:background "#e3e3d3" :underline nil :foreground "black" :box (:line-width 1 :color "gray77" :style unspecified)))))
