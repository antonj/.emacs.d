(defun aj-color-theme-jsc-light-grey ()
  ...
  (color-theme-install
   '(aj-color-theme-jsc-light
     ...
     ;; "#c70"
     ;; "#7c0"
     (highlight ((t (:background "#e3e3e3"))))
     (highlight-indentation-face ((t (:inherit highlight))))
     (highlight-indentation-current-column-face ((t (:background "#d3d3d3"))))
     ...
     (font-lock-comment-face ((t (:italic t :bold t :foreground "#999999"))))
     (font-lock-doc-face ((t (:inherit font-lock-comment-face))))
     (font-lock-comment-delimiter-face ((t (:inherit font-lock-comment-face :bold t :background "#dddddd"))))
