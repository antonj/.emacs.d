(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (neotree ag all-the-icons srefactor ido-completing-read+ ido-ubiquitous js-import dockerfile-mode graphql-mode golint go-eldoc protobuf-mode go-autocomplete go-mode tern-auto-complete tern browse-kill-ring wgrep wgrep-ag magit flycheck-flow nil swift-mode slim-mode flycheck)))
